                  ...
                  return (
                    ...
                    >
                        ...
                        <Badge
                          ...
                          sx={{
                            '& .MuiBadge-badge': {
                                backgroundColor: otherUser.status === 'online' ? '#44b700' : 'grey',
                                ...
                                '&::after': {
                                  ...
                                  height: '100%',
                              borderRadius: '50%',
                                  animation: otherUser.status === 'online' ? 'ripple 1.2s infinite ease-in-out' : 'none',
                        ...
                        >
                          <Avatar 
                              ...
                              sx={{ bgcolor: !otherUser.profileImage ? 'primary.main' : undefined }}
                            >
                              {!otherUser.profileImage && otherUser.fullName.charAt(0)}
                          </Avatar>
                        </Badge>
                      </ListItemAvatar>
                      <ListItemText
                            ...
                            >
                              <Chip 
                                ...
                                sx={{ 
                                  ...
                                  mr: 1,
                                    mb: 0.5,
                                    bgcolor: otherUser.role === 'teacher' ? 'rgba(76, 175, 80, 0.2)' : 'rgba(25, 118, 210, 0.2)', 
                                    color: otherUser.role === 'teacher' ? 'success.light' : 'primary.light',
                                  }}
                                />
                                {otherUser.campus && (
                                  <Chip 
              ...
              <>
                ...
                <Box sx={{ 
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center' }}>
                    <Avatar 
                      alt={selectedConversationDetails.otherParticipant?.fullName} 
                      src={selectedConversationDetails.otherParticipant?.profileImage || undefined}
                      sx={{ 
                        width: 40, 
                        height: 40, 
                        mr: 2,
                        bgcolor: !selectedConversationDetails.otherParticipant?.profileImage ? 'primary.main' : undefined 
                      }}
                    >
                      {!selectedConversationDetails.otherParticipant?.profileImage && 
                        selectedConversationDetails.otherParticipant?.fullName.charAt(0)}
                    </Avatar>
                ...
                <Box sx={{ 
                  ...
                  {messages.length === 0 ? (
                    ...
                    searchedMessages.length === 0 ? (
                      ...
                      <Box ref={messageContainerRef} sx={{ flex: 1, overflowY: 'auto', py: 2, px: 3 }}>
